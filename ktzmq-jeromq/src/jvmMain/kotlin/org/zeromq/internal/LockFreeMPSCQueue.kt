...
private class LockFreeMPSCQueueCore<E : Any>(private val capacity: Int) {
    ...
    companion object {
        ...
        private fun Long.updateHead(newHead: Int) =
            (this wo HEAD_MASK) or (newHead.toLong() shl HEAD_SHIFT)

        private fun Long.updateTail(newTail: Int) =
            (this wo TAIL_MASK) or (newTail.toLong() shl TAIL_SHIFT)
        ...
        private fun Long.addFailReason(): Int =
            if (this and CLOSED_MASK != 0L) ADD_CLOSED else ADD_FROZEN
    }
}
