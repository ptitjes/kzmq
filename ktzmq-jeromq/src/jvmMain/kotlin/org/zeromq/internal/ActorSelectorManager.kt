...
internal class ActorSelectorManager(context: CoroutineContext) : SelectorManagerSupport(),
            ...
            selector.use { s ->
                ...
                while (true) {
                    ...
                    cancelAllSuspensions(
                        m,
                        ClosedSendChannelException("Failed to apply interest: s closed")
                    )
                }
            }
        }
